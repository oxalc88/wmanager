...
History shows Conventional Commits with optional scopes (e.g., `feat(sales): ...`, `fix(docker): ...`), plus occasional imperative “Create ...” for infra. Stick to that style. Commit bodies should include a short bullet list of key changes followed by a brief rationale/impact paragraph. Avoid labeled sections like WHAT/WHY/FILES in the commit body.

Example:
```
refactor: improve authentication system security
...
- Include a short bullet list of key changes and a brief summary paragraph in the commit body.
...
## FORBIDDEN Elements for commits:
- **NEVER** include "Generated with [Claude Code](https://claude.ai/code)"
- **NEVER** include "Co-Authored-By: Claude [noreply@anthropic.com](mailto:noreply@anthropic.com)"
